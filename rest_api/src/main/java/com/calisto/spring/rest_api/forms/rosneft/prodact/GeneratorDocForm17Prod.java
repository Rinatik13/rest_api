...
public class GeneratorDocForm17Prod implements GeneratorDoc {
    String fileName = "Подтверждение Российского происхождения товаров";
    @Override
    public ByteArrayOutputStream launch(Company company, Tender tender, String date, double summ) {
            ...
            String bodyTextDocCom =
                    "подтверждает российское происхождение поставляемых товаров (включая комплектующие изделия/части)" +
                            ", предоставляя следующие документы документы, " +
                            "(декларацию о происхождении товара или сертификат о происхождении товара, " +
                            "сертификата на комплектующие изделия/части).\n" +
                            ...
                            "в отношении предоставления недостоверных сведений о стране происхождения товаров " +
                            "(в том числе комплектующих изделий/частей, указанных в заявке на участие в закупке. \n";
