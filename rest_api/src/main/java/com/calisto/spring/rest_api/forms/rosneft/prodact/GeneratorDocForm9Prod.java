...
public class GeneratorDocForm9Prod implements GeneratorDoc {
        String fileName = "Письмо о подаче заявки";
    @Override
...
//            }
            ...
            String bodyTextDoc2 =
                    "Настоящая заявка на участие в закупке имеет правовой статус оферты и действует " +
                            ...
                            "− соответствие минимальным требованиям предъявляемым при аккредитации " +
                            ...
                            "указаны в пп(2)-(6) п.2 Блока 2 документации о закупке/извещения.\n" +
                            "\n" +
                            "Дополнительно сообщаем, что при составлении данной заявки " +
                            fullSizeNameCompany +
                            ...
                            " не осуществлялся информационный обмен с потенциальными участниками " +
